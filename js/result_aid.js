...
var carnitine = function(){
  ...
  var text1_2 = document.createElement("p");
  text1_2.className = "reasoning";
  text1_2.innerText = "Carnitine is one of the most widely researched supplements out there, and for good reason! There are many benefits associated with fish oil, and it’s incredibly useful for the general population and can help everyone from athletes to sedentary individuals.";
...
var greenTeaExtract = function(){
  ...
  var text1_2 = document.createElement("p");
  text1_2.className = "reasoning";
  text1_2.innerText = "Green tea extract is one of the most widely researched supplements out there, and for good reason! There are many benefits associated with fish oil, and it’s incredibly useful for the general population and can help everyone from athletes to sedentary individuals.";
...
var wheyProtein = function(){
  ...
  var text1_2 = document.createElement("p");
  text1_2.className = "reasoning";
  text1_2.innerText = "Whey Protein is one of the most widely researched supplements out there, and for good reason! There are many benefits associated with fish oil, and it’s incredibly useful for the general population and can help everyone from athletes to sedentary individuals.";
